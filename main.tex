...
Programming (ASP) \citep{lifschitz2008} to plan and describe the environment
(e.g., which corridors connect with which hallways, and which doors are open). It
...
here our user can select a robot to connect t, by clicking on the robot's name
...
camera which is shown in the center. The robot's camera is placed in a position
on the robot that makes the user experience feel like a point of view camera.
This makes the experience more immersive and the tour more engaging.
