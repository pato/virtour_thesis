...
on the robot. Whereas, the guest UI is enabled any time the robot is running.
Furthermore, all leader operations that affect the robot (eg: rotating, or
navigating) require user authentication, to prevent unauthorized
...
for translatating the serialized socket commands to normal ROS commands. From
...
reasons, but will write it to disk ocasionally to support recovery.
