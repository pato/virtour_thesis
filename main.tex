...
\begin{abstract}
  ...
  telepresence system, which is safe to use, and provides value to our lab and
  department by allowing students that are unable to visit to experience the
  areas first-hand.
\end{abstract}
...
robots to efficiently and hierarchically plan high level tasks such as
navigating to rooms \citep{yang2014, khandelwal2014}. Virtour extends on this
and the work on navigation and localization to provide users with the ability
to navigate and track the robots remotely.
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{virtour_client}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{leader_ui}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{nav_ui}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{guestUI}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{virtour_server}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{scav_certs}
...
integration. Maxwell Svetlik for insightful comments and support through the
